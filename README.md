...
Fonte e notas complementares em [`docs/modelagem/diagrama-classes-geral.md`](docs/modelagem/diagrama-classes-geral.md)
(mesmo diagrama) e [`diagrama-classes-geral.puml`](docs/modelagem/diagrama-classes-geral.puml)
(versão PlantUML equivalente).
